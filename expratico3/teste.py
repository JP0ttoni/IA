...
print("fringe_size:", max_fringe_size)  
print("max_fringe_size:", max_fringe_size)
print("search_depth:", step + 1)  # Search depth e max search depth não são diretamente rastreados no código atual
print("max_search_depth:", step + 1)
end_time = time.time()
